        ...
        <div className="bg-white rounded-lg shadow-xs border border-gray-200 p-6 md:p-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 pb-6 border-b border-gray-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-slate-900 tracking-tight">Your Profile</h1>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-md border border-amber-200 bg-amber-50 p-4">
              ...
              <p className="text-[13px] text-amber-700 leading-relaxed">
                Make sure your email and study year are accurate. They are used to
                personalize your tests and subjects.
              </p>
            </div>
          </div>
        </div>
