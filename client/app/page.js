...
import { ArrowRight, BookOpen, Users, PieChart } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Link href="/signup" className="px-8 py-4 rounded-lg bg-[#fcd34d] text-emerald-950 font-bold text-lg hover:bg-[#fbbf24] transition-all flex items-center gap-2">
