  ...
  return (
    <div className="space-y-6 animate-pulse max-w-6xl">
      ...
      <div className="bg-white rounded-md border border-gray-200 shadow-xs overflow-hidden">
        <div className="grid grid-cols-12 gap-4 px-5 py-4 bg-gray-50/50 border-b border-gray-200">
        ...
        <div className="divide-y divide-gray-100">
          {Array.from({ length: 6 }).map((_, index) => (
            <div key={index} className="grid grid-cols-12 gap-4 px-5 py-4 items-center">
